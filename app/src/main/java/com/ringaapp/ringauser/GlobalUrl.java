...
/**
 * Created by sweety on 10/14/2017.
 */

class GlobalUrl {

    public static String user_signup = "http://quaticstech.in/projecti1andro/android_users_signup.php";
    public static String user_login="http://quaticstech.in/projecti1andro/android_users_login.php";
    public static String user_otpreverify="http://quaticstech.in/projecti1andro/new.php";
    public static String user_resetpassword="http://quaticstech.in/projecti1andro/android_users_otpreverify.php";
    public static String user_forgot="http://quaticstech.in/projecti1andro/android_users_forgot.php";
    ...
    public static String users_autolocation="http://quaticstech.in/projecti1andro/android_users_autolocation.php";
    public static String users_profiledeth="http://quaticstech.in/projecti1andro/android_users_profiledeth.php";
    public static String users_allcatsearch="http://quaticstech.in/projecti1andro/android_users_allcatsearch.php";
    public static String users_allcatsearchtwo="http://quaticstech.in/projecti1andro/android_users_allcatsearchtwo.php";
    public static String users_subcatrettwo="http://quaticstech.in/projecti1andro/android_users_subcatrettwo.php";
